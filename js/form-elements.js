...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/UI-kit/form-elements/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FormElements; });
/* harmony import */ var Components_checkbox_list_checkbox_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Components/checkbox-list/checkbox-list */ "./src/components/checkbox-list/checkbox-list.js");
/* harmony import */ var Components_date_dropdown_date_dropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Components/date-dropdown/date-dropdown */ "./src/components/date-dropdown/date-dropdown.js");
/* harmony import */ var Components_input_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Components/input/input */ "./src/components/input/input.js");
/* harmony import */ var Components_review_review__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Components/review/review */ "./src/components/review/review.js");
/* harmony import */ var Components_range_slider_range_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! Components/range-slider/range-slider */ "./src/components/range-slider/range-slider.js");
/* harmony import */ var Components_dropdown_dropdown__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! Components/dropdown/dropdown */ "./src/components/dropdown/dropdown.js");
/* harmony import */ var Components_pagination_pagination__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Components/pagination/pagination */ "./src/components/pagination/pagination.js");
...
var FormElements = /*#__PURE__*/function () {
  ...
  _createClass(FormElements, [{
    key: "init",
    value: function init() {
      var checkboxLists = document.querySelectorAll(".js-form-elements__checkbox-list");
      var dateDropdowns = document.querySelectorAll(".js-form-elements__datepicker");
      var maskedInput = document.querySelector(".js-form-elements__masked-input");
      var reviews = document.querySelectorAll(".js-form-elements__review");
      var rangeSlider = document.querySelector(".js-form-elements__range-slider");
      var dropdowns = document.querySelectorAll(".js-form-elements__dropdown");
      var pagination = document.querySelector(".js-form-elements__pagination");
      checkboxLists.forEach(function (checkboxList) {
        new Components_checkbox_list_checkbox_list__WEBPACK_IMPORTED_MODULE_0__["default"](checkboxList);
      });
      dateDropdowns.forEach(function (dateDropdown) {
        new Components_date_dropdown_date_dropdown__WEBPACK_IMPORTED_MODULE_1__["default"](dateDropdown);
      });
      new Components_input_input__WEBPACK_IMPORTED_MODULE_2__["default"](maskedInput, "masked");
      reviews.forEach(function (review) {
        new Components_review_review__WEBPACK_IMPORTED_MODULE_3__["default"](review);
      });
      new Components_range_slider_range_slider__WEBPACK_IMPORTED_MODULE_4__["default"](rangeSlider);
      dropdowns.forEach(function (dropdown) {
        new Components_dropdown_dropdown__WEBPACK_IMPORTED_MODULE_5__["default"](dropdown);
      });
      new Components_pagination_pagination__WEBPACK_IMPORTED_MODULE_6__["default"](pagination);
    }
  }, {
    key: "makeLikeOnFigma",
    value: function makeLikeOnFigma() {
      // Hovered input
      var inputWithHover = document.querySelector('[name="Text"]');
      inputWithHover.classList.add("input__element_hovered"); // DropdownBeds
      ...
      var dropdownExpanded = document.querySelector(".form-elements__element_expanded");
      var buttonPlusBedrooms = dropdownExpanded.querySelectorAll(".counter__button_value_plus")[0];
      var buttonPlusBeds = dropdownExpanded.querySelectorAll(".counter__button_value_plus")[1];
      setTimeout(function () {
      ...
      var checkbox = document.querySelectorAll(".checkbox-list")[1];
      var buttonTable = checkbox.querySelectorAll(".checkbox-list__label")[1];
      var buttonChair = checkbox.querySelectorAll(".checkbox-list__label")[2];
      var buttonBed = checkbox.querySelectorAll(".checkbox-list__label")[3];
      setTimeout(function () {
      ...
      var checkbox1 = document.querySelectorAll(".form-elements__checkbox-list")[2];
      var checkboxbuttonAnimals = checkbox1.querySelectorAll(".checkbox-list__label")[1];
      var checkboxbuttonGuests = checkbox1.querySelectorAll(".checkbox-list__label")[2];
      setTimeout(function () {
        $(checkboxbuttonAnimals).trigger("click");
        $(checkboxbuttonGuests).trigger("click");
      }, 10); // Radio buttons

      var radioButton = document.querySelectorAll(".radio-buttons__label")[0];
      setTimeout(function () {
        $(radioButton).trigger("click");
      }, 10); // Toggle label

      var toggleButton = document.querySelectorAll(".toggle__label")[0];
      setTimeout(function () {
        $(toggleButton).trigger("click");
      }, 10); // Like button

      var likeButton = document.querySelectorAll(".like-button__button")[1];
      setTimeout(function () {
        $(likeButton).trigger("click");
      }, 10); // DropdownGuests

      var dropdowmGuests = document.querySelectorAll(".form-elements__dropdown")[3];
      var dropdownGuestsButton = dropdowmGuests.querySelector(".input__element");
      setTimeout(function () {
        $(dropdownGuestsButton).trigger("click");
      }, 30); // Buttons

      var buttonRow1 = document.querySelector(".form-elements__button-row1");
      var hoveredButtonInRow1 = buttonRow1.querySelectorAll(".button")[1];
      hoveredButtonInRow1.classList.add("form-elements__button_hovereded");
      var buttonRow2 = document.querySelector(".form-elements__button-row2");
      var hoveredButtonInRow2 = buttonRow2.querySelectorAll(".button_bordered")[1];
      hoveredButtonInRow2.classList.add("form-elements__button_hovereded"); // DropdownGuests

      var inputOfdropdownGuestsExpanded = document.querySelectorAll('[name="guests"]')[2];
      var dropdownGuestsExpanded = document.querySelector(".form-elements__dropdown_expandedGuests");
      var buttonPlusAdults = dropdownGuestsExpanded.querySelectorAll(".counter__button_value_plus")[0];
      var buttonPlusChildren = dropdownGuestsExpanded.querySelectorAll(".counter__button_value_plus")[1];
      setTimeout(function () {
        $(inputOfdropdownGuestsExpanded).trigger("click");
        $(buttonPlusAdults).trigger("click");
        $(buttonPlusAdults).trigger("click");
        $(buttonPlusChildren).trigger("click");
      }, 30); // Like button in Review

      var review = document.querySelector(".review__like-button");
      var reviewLikeButton = review.querySelector(".like-button__button");
      setTimeout(function () {
...
/***/ "./src/UI-kit/form-elements/main.js":
/*!******************************************!*\
  !*** ./src/UI-kit/form-elements/main.js ***!
  \******************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _form_elements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-elements */ "./src/UI-kit/form-elements/form-elements.js");
/* harmony import */ var _form_elements_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form-elements.scss */ "./src/UI-kit/form-elements/form-elements.scss");


document.addEventListener('DOMContentLoaded', function () {
  new _form_elements__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
...
var CheckboxButton = /*#__PURE__*/function () {
  function CheckboxButton(checkboxListContainer) {
    var _this = this;

    _classCallCheck(this, CheckboxButton);

    _defineProperty(this, "handleCheckboxClick", function () {
      _this.checkboxListForm.classList.toggle("checkbox-list__form_opened");

      _this.checkmark.classList.toggle("checkbox-list__checkmark_direction_up");
    });

    this.checkboxList = checkboxListContainer.querySelector(".js-checkbox-list");
    this.init();
  ...
  _createClass(CheckboxButton, [{
    key: "init",
    value: function init() {
      this.checkboxListForm = this.checkboxList.querySelector(".js-checkbox-list_expandable .js-checkbox-list__form");
      this.checkmark = this.checkboxList.querySelector(".js-checkbox-list__checkmark");
    }
  }, {
...
var LikeButton = /*#__PURE__*/function () {
  function LikeButton(item) {
    ...
    _defineProperty(this, "handleLikeButtonClick", function () {
      if (_this.isLiked()) {
        _this.heart.innerHTML = "favorite_border";

        _this.heart.classList.remove("like-button__image_active");

        _this.item.classList.remove("like-button__button_active");

        _this.minusLike();
      } else {
        _this.heart.innerHTML = "favorite";

        _this.heart.classList.add("like-button__image_active");

        _this.item.classList.add("like-button__button_active");
  ...
  _createClass(LikeButton, [{
    ...
    value: function plusLike() {
      var counter = Number(this.numberOfLikes.innerHTML);
...
var Pagination = /*#__PURE__*/function () {
  ...
  _createClass(Pagination, [{
    key: "init",
    value: function init() {
      this.paginationContainer = this.item.querySelector(".js-pagination__container");
...
var RangeSlider = /*#__PURE__*/function () {
  function RangeSlider(item) {
    ...
    _defineProperty(this, "getFromAndTo", function () {
      var from = $(_this.item).data("from");
      var to = $(_this.item).data("to");

      _this.updateSign(from, to);
    });
  ...
  _createClass(RangeSlider, [{
    ...
    value: function showSighWithValues() {
      ...
      var from = $(".js-range-slider__item").data("from");
      var to = $(".js-range-slider__item").data("to");
...
/* harmony import */ var Components_like_button_like_button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Components/like-button/like-button */ "./src/components/like-button/like-button.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Review = /*#__PURE__*/function () {
  ...
  _createClass(Review, [{
    ...
    value: function init() {
      ...
      new Components_like_button_like_button__WEBPACK_IMPORTED_MODULE_0__["default"](this.likeButton);
    }
  }]);
