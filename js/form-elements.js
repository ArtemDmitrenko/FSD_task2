...
/* harmony import */ var Components_checkbox_btn_checkbox_btn__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Components/checkbox-btn/checkbox-btn */ "./src/components/checkbox-btn/checkbox-btn.js");
...
/* harmony import */ var Components_like_button_like_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Components/like-button/like-button */ "./src/components/like-button/like-button.js");
  ...
  _createClass(FormElements, [{
    ...
    value: function init() {
      ...
      checkboxLists.forEach(function (checkboxList) {
        new Components_checkbox_btn_checkbox_btn__WEBPACK_IMPORTED_MODULE_0__["default"](checkboxList);
      });
      dateDropdowns.forEach(function (dateDropdown, index) {
        new Components_date_dropdown_date_dropdown__WEBPACK_IMPORTED_MODULE_1__["default"](dateDropdown, index);
      });
      new Components_input_input__WEBPACK_IMPORTED_MODULE_2__["default"](maskedInput);
      likeButtons.forEach(function (likeButton) {
        new Components_like_button_like_button__WEBPACK_IMPORTED_MODULE_3__["default"](likeButton);
      });
    ...
    value: function makeLikeOnFigma() {
      ...
      inputWithHover.classList.add("input__element_hovered"); // Datapicker

      var func1 = function func1() {
        var datapickerWithData = document.querySelector(".js-input__date-dropdown_value_to");
      ...
      var func2 = function func2() {
        var datapickerWithRange = document.querySelector(".js-input__date-dropdown_with-range");
        datapickerWithRange.value = "19 авг - 23 авг";
      };

      setTimeout(func2, 20); // DropdownBeds
      ...
      var btnPlusBedrooms = dropdownExpanded.querySelectorAll(".counter__btn_value_plus")[0];
      var btnPlusBeds = dropdownExpanded.querySelectorAll(".counter__btn_value_plus")[1];
      setTimeout(function () {
      ...
      var checkbox1 = document.querySelectorAll(".form-elements__checkbox-btn")[2];
      ...
      var btnRow1 = document.querySelector(".form-elements__btn-row1");
      var hoveredBtnInRow1 = btnRow1.querySelectorAll(".btn")[1];
      hoveredBtnInRow1.classList.add("form-elements__btn_hovereded");
      var btnRow2 = document.querySelector(".form-elements__btn-row2");
      var hoveredBtnInRow2 = btnRow2.querySelectorAll(".btn_with-border")[1];
      hoveredBtnInRow2.classList.add("form-elements__btn_hovereded"); // DropdownGuests
      ...
      var btnPlusAdults = dropdownGuestsExpanded.querySelectorAll(".counter__btn_value_plus")[0];
      var btnPlusChildren = dropdownGuestsExpanded.querySelectorAll(".counter__btn_value_plus")[1];
      setTimeout(function () {
...
/***/ "./src/components/checkbox-btn/checkbox-btn.js":
/*!*****************************************************!*\
  !*** ./src/components/checkbox-btn/checkbox-btn.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CheckboxBtn; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var CheckboxBtn = /*#__PURE__*/function () {
  function CheckboxBtn(checkboxList) {
    ...
    _defineProperty(this, "handleCheckboxClick", function () {
      if (_this.isExpanded()) {
        _this.cbList.classList.toggle("checkbox-btn__expandableForm_show");

        _this.checkmark.classList.toggle("checkmark_direction_down");

        _this.checkmark.classList.toggle("checkmark_direction_up");
      }
    });
  ...
  _createClass(CheckboxBtn, [{
    key: "init",
    value: function init() {
      this.cbList = this.checkboxList.querySelector(".js-checkbox-btn__expandableForm");
    ...
    value: function isExpanded() {
      return this.checkboxList.firstElementChild.classList.contains("js-checkbox-btn__expandableName");
    }
  }]);
