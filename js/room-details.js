...
var Diagram = /*#__PURE__*/function () {
  ...
  _createClass(Diagram, [{
    ...
    value: function getAttributeInNumber(review) {
      var numberOfReviews = Number(this.item.dataset[review]);
    ...
    value: function calcLengthOfOneReview(numberOfReview) {
      var lengthOfReviewInPixels = this.lengthOfCircle * numberOfReview / this.sum;
    ...
    value: function drawElementsOfDiagram() {
      var $svg = this.item.querySelector('.js-diagram__chart');
    ...
    value: function printAllNumberOfReviews() {
      var wholeNumberOfReviews = this.item.querySelector('.js-diagram__total');
      wholeNumberOfReviews.innerHTML = "".concat(this.sum, "<br><span>\u0433\u043E\u043B\u043E\u0441\u043E\u0432</span>");
    }
  }]);
