...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pages/room-details/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/components/confirmation-form/confirmation-form.js":
/*!***************************************************************!*\
  !*** ./src/components/confirmation-form/confirmation-form.js ***!
  \***************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FormConfirmation; });
...
var FormConfirmation = /*#__PURE__*/function () {
  function FormConfirmation(form) {
    _classCallCheck(this, FormConfirmation);
  ...
  _createClass(FormConfirmation, [{
    key: "init",
    value: function init() {
      this.dateDropdowns = this.form.querySelectorAll(".js-confirmation-form__dates");
...
var Diagram = /*#__PURE__*/function () {
  ...
  _createClass(Diagram, [{
    ...
    key: "getAttributeInNumber",
    value: function getAttributeInNumber(review) {
    ...
    value: function getAttributes() {
      ...
      for (var review in this.model) {
        this.model[review] = this.getAttributeInNumber(review);
      }
    }
  }, {
    key: "calcSumOfReviews",
    value: function calcSumOfReviews() {
      this.sum = Object.values(this.model).reduce(function (previousValue, currentValue) {
        return previousValue + currentValue;
      });
    }
  }, {
    key: "calcLengthOfOneReview",
    value: function calcLengthOfOneReview(numberOfReview) {
      return this.lengthOfCircle * numberOfReview / this.sum;
    }
  }, {
    key: "calcLengthsOfAllReviews",
    value: function calcLengthsOfAllReviews() {
    ...
    key: "drawElementsOfDiagram",
    value: function drawElementsOfDiagram() {
      if (this.model.good) {
        this.$svg.insertAdjacentHTML("beforeend", "\n        <circle class='diagram__unit diagram__unit_good' r='58' cx='50%' cy=\"50%\" stroke=\"url(#linear-gradient-green)\" style=\"stroke-dasharray: ".concat(this.goodInPixels - 2, " ").concat(this.lengthOfCircle, "; stroke-dashoffset: -1\">\n        "));
      }

      if (this.model.amazing) {
        this.$svg.insertAdjacentHTML("beforeend", "\n        <circle class='diagram__unit diagram__unit_good' r='58' cx='50%' cy=\"50%\" stroke=\"url(#linear-gradient-yellow)\" style=\"stroke-dasharray: ".concat(this.amazingInPixels - 2, " ").concat(this.lengthOfCircle, "; stroke-dashoffset: ").concat(-(this.goodInPixels + 1), "\">\n        "));
      }

      if (this.model.notbad) {
        this.$svg.insertAdjacentHTML("beforeend", "\n        <circle class='diagram__unit diagram__unit_good' r='58' cx='50%' cy=\"50%\" stroke=\"url(#linear-gradient-purple)\" style=\"stroke-dasharray: ".concat(this.notbadInPixels - 2, " ").concat(this.lengthOfCircle, "; stroke-dashoffset: ").concat(-(this.amazingInPixels + this.goodInPixels + 1), "\">\n        "));
      }

      if (this.model.bad) {
        this.$svg.insertAdjacentHTML("beforeend", "\n        <circle class='diagram__unit diagram__unit_good' r='58' cx='50%' cy=\"50%\" stroke=\"url(#linear-gradient-black)\" style=\"stroke-dasharray: ".concat(this.badInPixels - 2, " ").concat(this.lengthOfCircle, "; stroke-dashoffset: ").concat(-(this.notbadInPixels + this.amazingInPixels + this.goodInPixels + 1), "\">\n        "));
      }
    }
  }, {
    key: "printAllNumberOfReviews",
    value: function printAllNumberOfReviews() {
      this.wholeNumberOfReviews.innerHTML = "".concat(this.sum, "<br><span>\u0433\u043E\u043B\u043E\u0441\u043E\u0432</span>");
    }
  }]);
...
/***/ "./src/pages/room-details/main.js":
/*!****************************************!*\
  !*** ./src/pages/room-details/main.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _room_details__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./room-details */ "./src/pages/room-details/room-details.js");
/* harmony import */ var _room_details_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./room-details.scss */ "./src/pages/room-details/room-details.scss");


document.addEventListener('DOMContentLoaded', function () {
  new _room_details__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RoomDetails; });
/* harmony import */ var Components_diagram_diagram__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Components/diagram/diagram */ "./src/components/diagram/diagram.js");
...
/* harmony import */ var Components_review_review__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Components/review/review */ "./src/components/review/review.js");
/* harmony import */ var Components_confirmation_form_confirmation_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Components/confirmation-form/confirmation-form */ "./src/components/confirmation-form/confirmation-form.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var RoomDetails = /*#__PURE__*/function () {
  ...
  _createClass(RoomDetails, [{
    key: "init",
    value: function init() {
      var formConfirmation = document.querySelector(".js-room-details__confirmation-form");
      var diagram = document.querySelector(".js-room-details__diagram");
      var header = document.querySelector("header");
      var reviews = document.querySelectorAll(".js-room-details__review-block-item");
      new Components_confirmation_form_confirmation_form__WEBPACK_IMPORTED_MODULE_3__["default"](formConfirmation);
      new Components_diagram_diagram__WEBPACK_IMPORTED_MODULE_0__["default"](diagram);
      new Components_header_header__WEBPACK_IMPORTED_MODULE_1__["default"](header);
      reviews.forEach(function (review) {
        new Components_review_review__WEBPACK_IMPORTED_MODULE_2__["default"](review);
      });
    }
  }]);
