...
// Datapicker
const func1 = () => {
  const datapickerWithData = document.querySelector('[name="dateDropdownWithDate"]');
...
const func2 = () => {
  const datapickerWithRange = document.querySelector('[name="dateDropdownWithRange"]');
...
const dropdownExpanded = document.querySelector('.formElements__element_expanded');
...
// Checkbox buttons
const checkbox1 = document.querySelectorAll('.formElements__checkbox-btn')[2];
...
// DropdownGuests
const dropdowmGuests = document.querySelectorAll('.formElements__dropdown')[3];
...
// Buttons
const btnRow1 = document.querySelector('.formElements__btnRow1');
const hoveredBtnInRow1 = btnRow1.querySelectorAll('.btn')[1];
hoveredBtnInRow1.classList.add('formElements__btn_hovered');
const btnRow2 = document.querySelector('.formElements__btnRow2');
const hoveredBtnInRow2 = btnRow2.querySelectorAll('.btn_border')[1];
hoveredBtnInRow2.classList.add('formElements__btn_hovered');

// DropdownGuests
const inputOfdropdownGuestsExpanded = document.querySelectorAll('[name="guests"]')[2];
const dropdownGuestsExpanded = document.querySelector('.formElements__dropdown_expandedGuests');
